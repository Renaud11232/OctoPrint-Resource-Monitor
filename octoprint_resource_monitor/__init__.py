...
class Resource_monitorPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_update_information(self):
		...
		return dict(
			resource_monitor=dict(
				displayName="Resource_monitor Plugin",
...
__plugin_name__ = "Resource_monitor Plugin"

def __plugin_load__():
	global __plugin_implementation__
	__plugin_implementation__ = Resource_monitorPlugin()
